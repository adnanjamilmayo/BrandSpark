        ...
        <div>
            ...
            <main>
                ...
                <section className="overflow-hidden bg-white dark:bg-transparent">
                    <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-24">
                        <div className="relative z-10 mx-auto max-w-2xl text-center">
                            <h1 className="text-balance text-4xl font-semibold md:text-5xl lg:text-6xl">AI-Powered SaaS Name Generator</h1>
                            <p className="mx-auto my-8 max-w-2xl text-xl">Generate unique, brandable names for your SaaS with complete branding kits including logos, colors, and slogans.</p>

                            <Button
                                asChild
                                size="lg">
                                <a href="#generator">
                                    <span className="btn-label">Start Generating</span>
                                </a>
                            </Button>
                        </div>
                    </div>
                            ...
                            <div className="[transform:rotateX(20deg);]">
                                <div className="lg:h-[44rem] relative skew-x-[.36rad]">
                                    <img
                                        ...
                                        src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&h=800&fit=crop&crop=entropy&auto=format&fm=webp&q=80"
                                    ...
                                    <img
                                        ...
                                        src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=800&fit=crop&crop=entropy&auto=format&fm=webp&q=80"
                                        alt="SaaS Dashboard Preview Dark"
                                        width={2880}
                                        height={2074}
                                    />
                                </div>
                ...
                <section className="bg-background relative z-10 py-16">
                    <div className="m-auto max-w-5xl px-6">
                        <h2 className="text-center text-lg font-medium">Trusted by innovative companies worldwide.</h2>
